...
const Groupmembercards = () => {
  return (
    <div
      className={`flex items-center justify-center  ${styles.members_cards} `}
    >
      <div
      ...
      <div className={` ${styles.members_cardscontent}  flex  flex-col `}>
        ...
        <div className={` ${styles.research_groupdetails3}`}> PhD student</div>
        <div className={` ${styles.research_groupdetails3}`}>
          Research interest:Terahertz metamaterial,polarization rotation
          devices, Electromagnetically induced transparency and toroidal
          metamaterial.
        </div>
        <div className={` ${styles.research_groupdetails3}`}>
          Google Scholar: Rakesh_GS
...
>>>>>>> 7273363c118d1c6dab30825484a2a27677811e90
    </div>
  );
};
