...
<div className={`${styles.research_group} flex flex-col  `}>
    ...
    <div className={`flex items-center justify-evenly ${styles.research_groupcontent}  `}>
        ...
        <div className={`w-1/2 flex  flex-col  ${styles.height4}`}>
            ...
            <div className={` ${styles.research_groupdetails1 }`}>Dr. Gagan Kumar</div>
            <br/>
            <div className={` ${styles.research_groupdetails2}`}>Associate Professor</div>
            <div className={` ${styles.research_groupdetails3}`}>
                ...
                <div className={` ${styles.research_groupdetails3}`}> Indian Institute of Technology Guwahati
        ...
        <div className={`w-1/2   ${styles.height4} flex  flex-col`}>
            <div className={`flex flex-col justify-center`}>
            <div className={` ${styles.research_groupdetails1 }`}> Research profile</div>
            <br/>
            <div className={` ${styles.research_groupdetails3}`}>OrcidID: <span className={` ${styles.research_groupids}`}>0000-0001-5867-0670</span> </div>
            <div className={` ${styles.research_groupdetails3}`}>
                
               

                
                ResearcherID: <span className={` ${styles.research_groupids}`}>E-3140-2013</span> 
                ...
                <div className={` ${styles.research_groupdetails3}`}> Scopus Author ID: <span className={` ${styles.research_groupids}`}>55553625600</span> </div>
                <div className={` ${styles.research_groupdetails3}`}>
                    Google Scholar: <span className={` ${styles.research_groupids}`}>
