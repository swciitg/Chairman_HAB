...
const Alumnicards = () =>  {
    ...
    return (
        ...
        <div className={`${styles.members_cardscontent}  flex  flex-col `}>
             ...
             <div className={` ${styles.research_groupdetails1 }`}>        Mr. Maidul Islam
             ...
             <br/>
             <div className={` ${styles.research_groupdetails2}`}>Assistant professor</div>
             <div className={` ${styles.research_groupdetails3}`}>
                 ...
                 <div className={` ${styles.research_groupdetails3}`}> Year of completion: 2018</div>
                 <div className={` ${styles.research_groupdetails3}`}>
